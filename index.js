...
const buttonForSecondCardElement = document.querySelector('#product2 button');

buttonForSecondCardElement.classList.remove('btn-primary');

const cardTitleElement = document.querySelector('#product3 .card-title');

cardTitleElement.classList.toogle('text-center');
